...
- **Open-source first** — Prometheus/Grafana over Datadog, Weaviate over pgvector, LiteLLM over proprietary gateways
- **Single agent framework** — LangGraph only; no overlapping orchestration libraries
...
docker compose up -d  # Redis, Postgres, Weaviate, Prometheus, Grafana, Tempo
